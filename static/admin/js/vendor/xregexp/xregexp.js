...
module.exports = function(XRegExp) {
     ...
     * category_reference descriptions in UAX #44 <http://unicode.org/reports/tr44/#GC_Values_Table>. Token
...
module.exports = function(XRegExp) {
    ...
    unicodeData.push({
        name: 'Assigned',
        // Since this is defined as the inverse of Unicode category_reference Cn (Unassigned), the Unicode
